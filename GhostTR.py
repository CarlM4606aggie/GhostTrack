...
# Default map zoom level for Google Maps links (8z = zoomed out, 15z = street level)
DEFAULT_MAP_ZOOM = "15z"
...
def IP_Track():
    ...
    lat = ip_data['latitude']  # keep as float for more precise map pin
